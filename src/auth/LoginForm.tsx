  ...
  return (
    <>
      <form action="">
        ...
        <button className="mb-2 block mx-auto w-7/12 py-2 bg-blue-500 text-white font-semibold rounded-md hover:bg-blue-600 transition-colors" type="submit">Submit</button>
      </form>
      <Link className="block mx-auto w-7/12 py-2 bg-orange-500 text-center text-white font-semibold rounded-md hover:bg-orange-600 transition-colors" to={'/auth/register'}>Register</Link>
    </>
  );
}
